...
def main() -> None:
    ...
    o = override("VP", "vice", "president", None, None)
    check("VP with no industry still fires (token rule)", o and o.occupation_code == "11-1021")
    o = override("Assistant Vice President", "assistant,vice", "president", "FIN", "FIN.BNK")
    check("assistant VP fires", o and o.occupation_code == "11-1021")
    check("Senior Vice President stays 11-1011 (O*NET)", override("Senior Vice President", "senior,vice", "president", "TEC", None) is None)
    check("Executive Vice President stays", override("Executive Vice President", "executive,vice", "president", "TEC", None) is None)
    check("functional VP never fires", override("Vice President of Sales", "vice", "president sales", "TEC", None) is None)
    check("Vice President, Marketing never fires", override("Senior Vice President, Marketing", "senior,vice", "marketing president", "TEC", None) is None)
    ...
    check("principal at consulting untouched (firm_principal dropped)", override("Principal", None, None, "PRO", "PRO.CONSL") is None)
