...
# Normalization
# --------------------------------------------------------------------------
# Canonical normalizer moved to cleanlib.text (audit F4, 2026-09-01) --
# re-imported verbatim so every calibrated mapping keeps its exact join keys.
from cleanlib.text import SOFT_STOP, normalize, token_key  # noqa: E402,F401
