...
STAGES: list[tuple[str, Path, list[Path]]] = [
    ...
    ("persons", ROOT / "persons" / "_manifest.json",
     [N / "education_person.parquet", N / "education.parquet", N / "career_steps.parquet",
      P / "steps.parquet", I / "results" / "step_industry.parquet"]),
